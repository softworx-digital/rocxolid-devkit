...
trait ArgumentsOptionsGettable
{
    /**
    ...
    /**
     * Get the argument path of the file that needs to be generated
     */
    protected function argumentPackage()
    {
     ...
     * Get the argument path of the file that needs to be generated
     */
    protected function argumentPath()
    {

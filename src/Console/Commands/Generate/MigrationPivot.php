...
class MigrationPivot extends AbstractCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'rocXolid:generate:migration-pivot';
    ...
    private function addRelationshipInModel($modelPath, $relationshipModel, $tableName)
    {
        ...
        $stub = $this->files->get($this->getConfig('many_many_relationship_stub'));
    ...
    {
        return $this->getConfig(strtolower($this->type) . '_stub');
    }
